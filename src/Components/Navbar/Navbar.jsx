...
const Navbar = () => {
    ...
    return (
        ...
        <div className='navbar flex flex-col  justify-between items-center p-4 shadow-[0_1px_3px_-2px_black] sm:flex-row  md:w-auto sm:gap-[0] xl:py-[12px] xl:px-[50px] lg:py-[12px] lg:px-[30px] md:py-[10px]'>
            ...
            <ul ref={menuRef} className='nav-menu hidden sm:h-[70px] sm:top-[50px] md:flex  mt-[29px] xl:mt-3 items-center list-none gap-[50px] text-[#626262] text-[20px] font-medium xl:gap-[30px] xl:text-[16px] lg:gap-[25px] lg:text-[14px]  h-[80px]   bg-white justify-center top-[50px]  '>
            ...
            <div className='nav-login-cart gap-10 mt-2 sm:scale-[0.8] flex items-center sm:gap-[45px] xl:gap-[30px] '>
              <Link to='/login'><button className='w-17 h-8 sm:w-[157px] sm:h-[58px] outline-none border-[1px] border-solid border-[#7a7a7a] rounded-[75px] text-[#515151] text-[20px] font-medium bg-white cursor-pointer active:bg-[#f3f3f3] xl:w-[120px] xl:h-[45px] xl:text-[16px] lg:w-[80px] lg:h-[35px] lg:text-[14px]'>Login</button></Link> 
               <Link to='/cart'><img className='lg:w-[30px]' src={cart_icon} alt="" /></Link>
                <div className='nav-cart-count w-[22px] h-[22px] flex justify-center mt-[-35px] xl:ml-[-42px] ml-[-55px] rounded-[11px] text-[14px] bg-red-600 text-white lg:w-[18px] lg:h-[18px  ] '>{getTotalCartItems ()}</div>
            </div>
        </div>
    );
};
